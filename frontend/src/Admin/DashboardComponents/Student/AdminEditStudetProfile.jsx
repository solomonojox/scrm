...
const AdminEditStudetProfile = ({ studentId }) => {
            ...
            try {
                ...
                if (response.data.data) {
                    ...
                    setStudentData({
                        ...
                        guardianId: response.data.data.guardianId || '',
                        teacherId: response.data.data.teacher.teacherId || '',
                        currentTerm: "",
                        sessionId: ""
                    });
                }
    ...
    }, [studentId, profilePhotoUrl, trigger, showOverlay, hideOverlay]);
                ...
                <div className="mx-0 md:mx-2 lg:mx-2 space-y-4">
                    <div className="w-full h-36 bg-white p-4 rounded-lg flex items-center gap-4 relative">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">{userData.classroom.name}</p>
                        </div>
                        <button
...
export default AdminEditStudetProfile