      ...
      <footer className="bg-white border-t">
        <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="mt-4 sm:mt-0 space-x-4">
            <a href="#" className="text-gray-600 hover:text-gray-600 text-sm">Privacy Policy</a>
            <a href="#" className="text-gray-600 hover:text-gray-600 text-sm">Terms of Service</a>
          </div>
        </div>
      </footer>
    </div>
