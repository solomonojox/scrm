...
const SchoolFeeTable: React.FC<StudentTableProps> = ({
  ...
  const toggleSelectAll = () => {
    if (selectAll) {
      ...
      setSelectedIds(schoolFee.map((s: any) => s.id));
    }
            ...
            {schoolFee.length === 0 ? (
              ...
              schoolFee.map((student, index) => (
                ...
                >
                  ...
                  <td className="p-3">
                    <img
                      src={`https://api.dicebear.com/7.x/adventurer/svg?seed=${student.classroomId}`}
                      alt="avatar"
                  ...
                  <td
                    className="p-3 flex items-center gap-3 cursor-pointer hover:text-orange-600 font-semibold"
                    onClick={() => {
                      setEditData(student);
                      onAddStudent();
                    }}
