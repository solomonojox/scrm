...
// const SchoolFeeForm: React.FC<GuardianFormProps> = ({ onClose, onGuardianAdded }) => {
...
//       toast.success(res.responseMessage || "School Fee added!");
//       onGuardianAdded();
//       setTimeout(() => {
//         onClose();
//         setFormData({
...
//                 name={key}
//                 placeholder={label}
//                 required={["schoolId", "sessionId", "amount"].includes(key)}
