    ...
    <div className="bg-gray-100 min-h-screen flex flex-col font-inter">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <Link
            to="/addschoolform"
            className="mt-4 bg-orange-600 hover:bg-orange-700 text-white font-semibold text-sm sm:text-base py-2 px-5 rounded-md"
          >
            Register School
          </Link>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-16 pb-10 flex gap-x-6 overflow-x-auto z-10 relative">
        {[
          {
            icon: "fa-school",
            title: "Add School",
