...
const TeacheTable = () => {
  return (
    <div>
        {/* student table */}
        <h1 className="text-lg font-semibold mb-6">Student Table</h1>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th className="text-left text-sm p-3">Student ID</th>
                    <th className="text-left text-sm p-3">Class</th>
                    <th className="text-left text-sm p-3">Status</th>
                    <th className="text-left text-sm p-3">Actions</th>
                </tr>
            </thead>
            <tbody>
                <tr>
