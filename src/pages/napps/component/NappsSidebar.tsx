...
type NavItemId = "dashboard" | "schools" | "chapters" | "chapter-admins";
...
const NAV_ITEMS: NavItem[] = [
    ...
    { id: "chapter-admins", label: "Chapter Admins", icon: MessageSquare, path: '/napps/super-admin/chapter-admins' },
];
                ...
                {NAV_ITEMS.map(({ id, label, icon: Icon, path }) => {
                    ...
                    return (
                        <button
                            ...
                            onClick={() => {handleNav(id); navigate(path)}}
