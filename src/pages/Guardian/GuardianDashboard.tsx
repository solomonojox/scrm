...
import { Check, Copy, X, GraduationCap, Wallet, CalendarCheck } from "lucide-react";
import {
    ...
    <div className="">
      <main className="mx-4 lg:mx-0">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-5">
          ...
          <button
            ...
            className="bg-orange-600 text-white text-xs font-semibold rounded-xl px-4 py-3 whitespace-nowrap hover:bg-orange-700 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <div
              className="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm overflow-x-auto"
              style={{ minWidth: 320 }}
            >
            ...
            {/* Transaction history — this is now the only payment record shown */}
            <div
          ...
          <div className="h-full">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-6 h-full flex flex-col">
              <h3 className="font-semibold text-[18px] text-gray-900 mb-6">Attendance Summary</h3>

              <div className="flex-1 flex flex-col justify-center gap-8">
                <div className="text-center">
                  <p className="text-[13px] font-medium text-gray-500 mb-2">Jason</p>
                  <div className="relative w-28 h-28 mx-auto">
                    <Doughnut data={attendanceDataJason} options={doughnutOptions} />
                  </div>
                  <div className="flex justify-center space-x-4 mt-3 text-[11px] text-gray-600">
                ...
                <div className="text-center">
                  <p className="text-[13px] font-medium text-gray-500 mb-2">Joy</p>
                  <div className="relative w-28 h-28 mx-auto">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-h-[550px] overflow-auto parent-scrollbar shadow-xl max-w-lg w-full mx-4 relative">
            ...
            <div className="px-6 py-4 border-t border-gray-200 flex justify-end">
              <button
                onClick={() => setIsModalOpen(false)}
                className="bg-orange-600 hover:bg-orange-500 text-white font-medium py-2 px-4 rounded-xl transition-colors duration-200"
              >
                Close
              </button>
            </div>
