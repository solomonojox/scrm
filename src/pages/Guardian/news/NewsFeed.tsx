...
export default function NewsFeed() {
  ...
  const newsInfo = location.state.article;
    ...
    <div className="bg-white text-gray-900 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-6 md:p-8">
        ...
        <article className="mx-auto text-base leading-relaxed text-gray-900 max-w-3xl">
          <p className="text-center text-orange-600 font-bold text-3xl mb-2">{newsInfo?.title}</p>
          ...
          <div className="flex justify-center gap-2 mb-6 text-sm">
            <div className="flex-1 max-w-[33%] border border-gray-300 rounded text-center px-2 py-1">
              Date: {formatDateTime(newsInfo?.publishedDate)}
            </div>
            <div className="flex-1 max-w-[33%] border border-gray-300 rounded text-center px-2 py-1">
              Time: 12:30pm
            </div>
          ...
          {/* <p className="font-semibold mb-1">Why Home–School Collaboration Matters</p>
          <p className="mb-2">
            Children learn best when they feel supported not just in the classroom, but also at
            home. When parents are involved in their child’s education, students are more likely to:
          </p>
          ...
          <p className="font-semibold mb-1">What Collaboration Looks Like in Practice</p>
          <p className="mb-2">
            True home–school collaboration goes beyond occasional PTA meetings or report card days.
            It involves ongoing communication, shared goals, and joint efforts to support students
            holistically.
          </p>
          ...
          <ul className="list-disc list-inside mb-4">
            <li>
              Consistent Communication: Teachers sharing updates on student progress; parents
              providing feedback or context from home
            </li>
            <li>
              Participation in School Life: Parents attending school events, workshops, and
              volunteering when possible
            </li>
            <li>
              Supporting Learning at Home: Creating structured routines for homework, reading, and
              rest
            </li>
            <li>
              Mutual Respect and Understanding: Acknowledging each other’s role in a child’s
              development and working together without blame
            </li>
          </ul>

          <p className="font-semibold mb-1">How Schools Can Foster Better Collaboration</p>
